			    ...
			    spacing: 8
					...
					Rectangle {
						...
						color: "#565f89"
                            ...
                            Rectangle {
                                property real animatedHeight: (( contentLayout.height - (contentLayout.spacing * 3) - thumb.implicitHeight - contentLayout.anchors.topMargin - contentLayout.anchors.bottomMargin + 2 ) * (Pipewire.defaultAudioSink?.audio.volume > 1 ? 1 : Pipewire.defaultAudioSink?.audio.volume) ) ?? 0
                                Layout.alignment: Qt.AlignHCenter
