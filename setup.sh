...
install_programs() {
    ...
    # AUR packages
    paru -Sy --noconfirm \
        beeper-v4-bin hyprhalt hyprquickframe-git quicksnip-git
...
link_dotfiles() {
    ...
    create_symlink "$DOTFILES_DIR/.config/hyprquickframe" "$HOME/.config/hyprquickframe"
    ...
    create_symlink "$DOTFILES_DIR/.local/bin/battery-notify.sh" "$HOME/.local/bin/battery-notify"
    ...
    create_symlink "$DOTFILES_DIR/media/music/audio-volume-change.wav" "$HOME/Music/audio-volume-change.wav" # desktop
